...
Lemma canonical_forms_nat : forall v,
  empty |-- v \in Nat -> value v -> exists (n : nat), v = <{ n }>.
Proof with eauto.
  intros.
...
Lemma canonical_forms_fun : forall v S T,
  empty |-- v \in (S -> T) -> value v -> exists x u t, v = <{\x:u,t}>.
Proof with eauto.
  intros.
  inversion H; subst; clear H;
  try solve_by_invert...
...
Proof with eauto.
  ...
  - (* T_App *)
    destruct IHhas_type1 as [|[]]...
      edestruct (canonical_forms_fun t1)...
      destruct H2 as [? [?]]; subst...
      destruct IHhas_type2 as [|[]]...

  - (* T_If0 *)
    destruct IHhas_type1 as [|[]]...
      edestruct (canonical_forms_nat t1)... subst.
      destruct x0...

  - (* T_Succ *)
    destruct IHhas_type as [|[]]...
      destruct (canonical_forms_nat t); subst...
  ...
  - (* T_Mult *)
    destruct IHhas_type1 as [|[]], IHhas_type2 as [|[]]...
      destruct (canonical_forms_nat t1),
                (canonical_forms_nat t2); subst...
Qed.
